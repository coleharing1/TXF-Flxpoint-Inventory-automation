/**
 * @fileoverview FINAL FLXPoint Export Script - Fixed Database Constraints
 * 
 * ✅ STATUS: PRODUCTION READY
 * This script is based on the working reference and includes fixes for database constraint issues.
 * 
 * IMPROVEMENTS OVER WORKING VERSION:
 * ✅ All functionality from flxpoint-export-working.js
 * ✅ Fixed database constraint error for NULL SKU values
 * ✅ Enhanced data validation before database save
 ...
 * ✅ Database constraint handling (filters out invalid rows)
 ...
 * 
 * USAGE:
 * - Test mode: TEST_MODE=true node src/automation/flxpoint-export-final.js
 * - Production: Use via daily-inventory-run.js
 */
